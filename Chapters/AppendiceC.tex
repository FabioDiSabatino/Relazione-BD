...
CREATE or REPLACE FUNCTION esposizione(tabInput text, alphaSlope FLOAT, raggioBuffer FLOAT) RETURNS VOID
	...
	BEGIN
		...
		FOR areaVicina IN (SELECT * FROM zoneVicine) LOOP
			...
			INSERT INTO tabella_risultati(id, geom, quota, pendenza, exposure) VALUES (stazione.gid, stazione.geom, quotaStimataStazione, (fattorePendenzaPiuVicina*pesoPendenza), exp);
		END LOOP;
