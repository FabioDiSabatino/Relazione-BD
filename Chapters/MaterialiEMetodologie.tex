\chapter{Materiali e Metodi} % Chapter title
...
\myfloatalign
\subfloat[]
{\label{fig:example-a}\includegraphics[width=.45\linewidth]{img/curva}} \quad
\subfloat[]
{\label{fig:example-b}
...
ss}{FindCompress}
	...
	\Output{\textit{B}}
	\KwResult{Calcola l'$exposure$ di tutte le  b$_i$}
