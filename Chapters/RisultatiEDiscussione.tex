...
La classifica riportata in tabella \ref{top20segmenti} mostra i primi venti (di $690$) segmenti con relativo valore di \textit{exposure} e linea di appartenenza.
\begin{table}[h]
\centering
\begin{tabular}{|c|c|c|c|}
\hline
