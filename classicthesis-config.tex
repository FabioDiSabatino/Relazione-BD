...
keywords=[3]{SELECT, IN, FROM, INTO, INSERT, VALUES, WHERE, UPDATE, SET, DELETE, NOT, ORDER BY, AND, OR, DROP, TABLE, PERFORM, EXECUTE, SERIAL, PRIMARY, KEY},
keywords=[4]{quotaMediaZoneVicine, stimaQuotaStazione, dislivelloPiuVicino}
 }
