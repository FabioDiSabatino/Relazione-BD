...
keywords=[2]{CREATE, or, REPLACE, FUNCTION, LANGUAGE, as, DECLARE, BEGIN, END, RETURNS, FOR, LOOP, IF, THEN, END IF, END LOOP, RETURN, ELSE},
keywords=[3]{SELECT, IN, FROM, INTO, INSERT, VALUES, WHERE, UPDATE, SET, DELETE, NOT, ORDER BY, AND, OR, DROP, TABLE, PERFORM, EXECUTE, SERIAL, PRIMARY, KEY, ALTER, SEQUENCE},
keywords=[4]{quotaMediaZoneVicine, stimaQuotaStazione, dislivelloPiuVicino, semplificaLinee}
 }
